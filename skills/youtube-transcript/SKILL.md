...
```bash
python3 skills/youtube-transcript/scripts/fetch-transcript.py "<youtube-url>"
```
...
```bash
# Basic transcript
python3 skills/youtube-transcript/scripts/fetch-transcript.py "https://www.youtube.com/watch?v=dQw4w9WgXcQ"

# Spanish transcript
python3 skills/youtube-transcript/scripts/fetch-transcript.py "https://youtu.be/dQw4w9WgXcQ" --lang es

# With timestamps
python3 skills/youtube-transcript/scripts/fetch-transcript.py "dQw4w9WgXcQ" --timed
```
