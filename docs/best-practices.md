...
- **For code: write tests first** — see `docs/tdd-workflow.md` for Red-Green-Refactor
...
Skip steps 3-5 for non-code changes (docs, config). Skip planning for trivial changes. See `docs/tdd-workflow.md` for TDD details.
